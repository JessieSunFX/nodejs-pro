...
var _setting = _interopRequireDefault(require("./setting.css"));
  ...
  _createClass(Setting, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", {
        className: "setting"
      }, this.context.map(function (tab) {
        return _react["default"].createElement("li", null, tab.name);
      }));
    }
  }]);
...
_defineProperty(Setting, "contextType", _tabContext["default"]);

var _default = (0, _reactRedux.connect)(function mapStateToProps(state) {
